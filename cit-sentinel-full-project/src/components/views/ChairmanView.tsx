...
export default function ChairmanView({ activePage = "dashboard" }: { activePage?: string }) {
  ...
  const projectionData = Array.from({length: 16}, (_, i) => ({
    week: `Week ${i+1}`,
    withoutSentinel: Math.min(95, 15 + i * 5),
    withSentinel: Math.max(5, 15 - i * 0.5 + (i > 4 ? 2 : 0)),
  }));
                ...
                <div className="flex-1 min-h-[280px] w-full mt-4">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={weeklyRiskData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                      ...
                      />
                      <ReferenceLine x="W3" stroke="var(--glow-gold)" strokeDasharray="4 4" label={{ position: 'top', value: 'Sentinel Trigger Window', fill: 'var(--glow-gold)', fontSize: 10, fontWeight: "bold" }} />
              ...
              <div className="card-warm p-6 shadow-sm flex flex-col items-center text-center border-border/50 card-glow-hover animate-fade-up" style={{ animationDelay: "0.2s", animationFillMode: "both" }}>
                ...
                <div className="w-full flex justify-between items-center mt-auto bg-surface-warm/50 p-4 rounded-xl border border-border/50 shadow-inner">
                  <div className="text-center">
                    <p className="text-[9px] section-label uppercase tracking-widest mb-1">Without Sentinel</p>
                  ...
                  <div className="text-center">
                    <p className="text-[9px] section-label uppercase tracking-widest mb-1">With Sentinel</p>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={projectionData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                      ...
                      <Tooltip 
                        contentStyle={{ backgroundColor: 'var(--surface)', borderColor: 'var(--border)', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' }}
                        itemStyle={{ fontSize: '13px' }}
                        formatter={(value: number, name: string) => [`${value}%`, name === 'withoutSentinel' ? 'Without Sentinel' : 'With Sentinel']}
                      />
                      <Legend verticalAlign="top" height={40} wrapperStyle={{ fontSize: '12px', fontWeight: 'bold' }} />
                      <ReferenceLine x="Week 3" stroke="#ca8a04" strokeDasharray="4 4" label={{ position: 'top', value: 'Sentinel Activated', fill: '#ca8a04', fontSize: 10, fontWeight: 'bold' }} />
                      <Area type="monotone" dataKey="withoutSentinel" name="Without Sentinel" stroke="#dc2626" strokeWidth={3} fillOpacity={1} fill="url(#colorWithout)" />
                      <Area type="monotone" dataKey="withSentinel" name="With Sentinel" stroke="#16a34a" strokeWidth={3} fillOpacity={1} fill="url(#colorWith)" />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
        ...
        {activeTab === "Institution Report" && (
          <div className="max-w-4xl mx-auto rounded-2xl bg-[#fafafa] p-8 md:p-12 shadow-2xl text-black animate-fade-up border border-border/20 relative overflow-hidden" style={{ animationDelay: "0.1s", animationFillMode: "both" }}>
            ...
            <div className="text-center mb-12 relative z-10">
              ...
              <h1 className="text-3xl font-serif font-bold text-[#800000] uppercase tracking-widest mb-2">Chennai Institute of Technology</h1>
              ...
              <p className="text-xs text-gray-500 mt-4 font-mono font-medium">Semester IV, Academic Year 2025-26 • Generated by <span className="text-[#800000] font-bold">CIT-Sentinel</span> | Confidential</p>
            </div>
            ...
            <div className="space-y-10 relative z-10 font-serif">
              <section>
                ...
                <p className="text-base text-gray-800 leading-relaxed font-medium">
                  During Semester IV, CIT-Sentinel successfully monitored a cohort of <strong className="font-bold text-black border-b border-[#ffd700] bg-[#ffd700]/10 px-1">{students.length}</strong> students across 4 departments. 
